...
interface SortsListProps {
    setCurrentSortMethod: Function
    isSortRunning: boolean
    currentSortMethod: string
}

function SortsList({setCurrentSortMethod, isSortRunning, currentSortMethod}: SortsListProps): ReactElement {
